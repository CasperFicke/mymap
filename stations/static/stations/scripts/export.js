/* stations/static/stations/scripts/export.js */
var mapcenter = [52.5, 4.95];
var map = L.map('map', {zoomControl: false}).setView(mapcenter, 13);

var osm = L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
  attribution: 'powered by datalab'
}).addTo(map);
...
// Export Button
var showExport = '<a href="#" onclick="geojsonExport()" title="Export to GeoJSON File" type="button" class="btn btn-danger btn-sm text-light"><i class="far fa-file-export" aria-hidden="true"></i> Export</a>';
